...
const weekStart = (date: Date, addedDays = 0) => startOfWeek(addDays(date, addedDays), { locale: ru });
const weekEnd = (date: Date, addedDays = 0) => endOfWeek(addDays(date, addedDays), { locale: ru });
